<template>
  <section id="work-section" class="mx-16 mt-32">
    ...
    <div id="flashcards" class="mt-32">
      ...
      <div class="mt-8 lg:w-[50%]">
        <p>
          After searching for a flashcard app or website that could visualize my
          learning progress and motivate me every time I opened the application,
          I realized such a tool was missing from the market.
        </p>
        <br />
        <p>
          Therefore, I took matters into my own hands and built one by myself.
          This flashcard app is designed to track your learning journey by
          visualizing your progress in a motivating manner. Each time you open
          the app, you'll be greeted with insights into how far you've come,
          encouraging you to keep pushing forward.
        </p>
      </div>
    ...
    <div id="music" class="mt-64">
      ...
      <div class="mt-8 lg:w-[50%]">
        <p>
          This project is built using Vue.js, Firebase, Tailwind and some other
          packages like Pinia, Vue-Router , Vue-i18n, Vee-Validate, Howler. It's
          an example for a music website where you can upload and listen to
          songs.
        </p>
        <br />
