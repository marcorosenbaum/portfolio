        ...
        <div class="flex gap-20 mt-16">
          ...
          <div class="flex items-center gap-5 stroke-shadow duration-200">
            ...
            <label for="github-icon" class="text-2xl"
              ><a
                target="_blank"
                href="https://github.com/marcorosenbaum/memory-game"
                >Github</a
              ></label
            >
          </div>
        ...
        <div class="flex gap-20 mt-16">
          ...
          <div class="flex items-center gap-5 stroke-shadow">
            ...
            <label for="github-icon" class="text-2xl"
              ><a
                target="_blank"
                href="https://github.com/marcorosenbaum/music-example"
                >Github</a
              ></label
            >
          </div>
        ...
        <div class="flex gap-20 mt-16">
          ...
          <div class="flex items-center gap-5 stroke-shadow duration-200">
            ...
            <label for="github-icon" class="text-2xl"
              ><a
                target="_blank"
                href="https://github.com/marcorosenbaum/vtg-musli"
                >Github</a
              ></label
            >
          </div>
        ...
        <div class="flex gap-20 mt-16">
          ...
          >
            <div class="flex items-center gap-5 stroke-shadow">
              ...
              <label for="github-icon" class="text-2xl">Github</label>
            </div>
          </a>
        </div>
      </div>
