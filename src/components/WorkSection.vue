        ...
        <div class="flex gap-20 mt-16">
          <div class="flex gap-2 items-center stroke-shadow w-fit">
            ...
            <a
              class="pl-4"
              target="_blank"
              href="https://marco-flashcards.netlify.app"
              >Website</a
            >
          </div>
        ...
        <div class="flex gap-20 mt-16">
          <div class="flex gap-2 items-center stroke-shadow w-fit">
            ...
            <a
              class="pl-4"
              target="_blank"
              href="https://swedish-memory-game.vercel.app/"
              >Website</a
            >
          </div>
          <GithubLink
        ...
        <div class="flex gap-20 mt-16">
          <div class="flex gap-2 items-center stroke-shadow w-fit">
            ...
            <a
              class="pl-4"
              target="_blank"
              href="https://marco-music.netlify.app/"
              >Website</a
            >
          </div>
          <GithubLink
      ...
      <div class="text-vtg lg:w-2/5">
        ...
        <div class="flex gap-20 mt-16">
          <div class="flex gap-2 items-center stroke-shadow w-fit">
            ...
            <a class="pl-4" target="_blank" href="https://www.vtg-musli.de/"
              >Website</a
            >
          </div>
